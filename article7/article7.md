...
[^16]: `Python-ideas` 메일링 리스트의 ['yield from: 완료를 보장한다<sup>Yield-From: Finalization guarantees</sup>’](https://mail.python.org/pipermail/python-ideas/2009-April/003884.html)
에서 발췌. 귀도가 말한 데이비드 비즐리의 튜토리얼은 ['코루틴 및 동시성에 대한 흥미로운 강의<sup>A Curious Course on Coroutines and Concurrency</sup>’](https://www.dabeaz.com/coroutines/)다.